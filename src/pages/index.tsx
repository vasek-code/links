...
const IndexPage: NextPage = () => {
  ...
  return (
    <>
      <IndexMenu opened={opened} />
      <Flex w="100%" h="100vh" pt="40px">
            ...
            >
              <InputGroup>
                <InputLeftElement pointerEvents="none" h="100%">
                  <BiSearchAlt color="#bbbbbb" size="25px" />
                </InputLeftElement>
                <Input
                  w="100%"
                  h="100%"
            ...
            {status === "authenticated" ? (
              <>
                <Flex flexDir="column" h="100%">
                  <IconButton
                    aria-label={data.user?.name as string}
                    h="100%"
                    pr="10px"
                    onClick={() => {
                      setOpened(!opened);
